# -*- coding: utf-8 -*-
{
    ...
    'description': "Recalcula el consolidado real de cesantias, intereses, prima y vacaciones a "
                   ...
                   "contra la provision contabilizada y muestra el ajuste.",
    'author': "PROIMPO SAS",
    'license': "LGPL-3",
    'category': "Human Resources",
    'version': "19.0.1.4.3",
    'depends': ['l10n_co_hr_payroll_enterprise', 'proimpo_nomina_liquidacion', 'proimpo_nomina_contabilidad'],
    'data': [
        'security/ir.model.access.csv',
        'views/cierre_prestaciones_views.xml',
    ],
    'installable': True,
    'application': False,
}
