...
class SaleOrder(models.Model):
	...
	def check_credit_limit(self):
		...
		#print('pedidos no facturados: ',due_notinv)
    ...
    # Busca solo las facturas vencidas
		...
		#print('all_date_due ',all_date_due)

		new_balance=self.amount_total + all_due + due_notinv
		#print('nuevo saldo ',new_balance)
		#print('crédito concedido ',partner.my_credit_limit)
