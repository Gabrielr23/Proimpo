...
class SaleConfirmLimit(models.TransientModel):
	...
	invoice_amount = fields.Float('Pedido actual',readonly=True)
	debt = fields.Float('Cartera actual',readonly=True)
	my_credit_limit = fields.Float('Crédito concedido',readonly=True)
	new_balance = fields.Float('Nuevo saldo',readonly=True)
	due_not_invoiced = fields.Float('Pedidos por facturar',readonly=True)
	balance_due = fields.Float('Total vencido',readonly=True)
