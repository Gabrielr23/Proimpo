    ...
    #def _reg_encabezado(self): 
        ...
        for record in self.env['account.payment'].browse(active_ids):
            if record:
                ...
                text_reg_2 = '6' + id_partner.rjust(15,'0') + name_partner[0:18] + cod_bank.rjust(9,'0') + cta_partner.ljust(17, "0") + 'S' + transaccion + valor.zfill(10) + record.name[0:9] + record.vat[0:9] + ' '  
