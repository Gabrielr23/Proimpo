...
class CreateNovedadesConsolidatedWizard(models.TransientModel):
    ...
    def create_hr_novedeades(self):
        ...
        for line in self.consolidated_id.details_ids:
            ...
            if line.liquidation_type == 'C' and self.ajuste_cesantias:   
               vals_prov = {
                  'date_from': self.date_start,
                  'date_to': self.date_stop,
                  'employee_id': line.employee_id.id,
            ...
            if line.liquidation_type == 'IC' and self.ajuste_cesantias:
               vals_prov = {
                  'date_from': self.date_start,
                  'date_to': self.date_stop,
                  'employee_id': line.employee_id.id,
            ...
            if line.liquidation_type == 'V' and self.ajuste_vacaciones:   
               vals_prov = {
                  'date_from': self.date_start,
                  'date_to': self.date_stop,
                  'employee_id': line.employee_id.id,
